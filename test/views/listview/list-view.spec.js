describe('Directive:  pfDataList', function () {
  ...
  beforeEach(function () {
    ...
    var htmlTmp = '<div pf-list-view items="systemModel" config="listConfig" actions="actions" update-action-for-item-fn="updateActionForItemFn">' +
  ...
  it('should show the actions menu button for each row', function () {
    var menuButtons = element.find('.list-view-pf .list-menu .dropdown-toggle');
    expect(menuButtons.length).toBe(5);
  });

  it('should show the actions menu with the correct items', function () {
    var menuButtons = element.find('.list-view-pf .list-menu .dropdown-toggle');
    var menus = element.find('.list-view-pf .list-menu .dropdown-menu');
  ...
  it ('should not show action components when actions are not supplied', function () {
    ...
    menuButtons = element.find('.list-view-pf .list-menu .dropdown-toggle');
