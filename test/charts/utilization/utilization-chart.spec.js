describe('Directive: pfUtilizationChart', function() {
  ...
  it("should update the current and center labels when attribute changes", function() {
    $scope.cLabel = 'used';
    element = compileChart('<div pf-utilization-chart config="config" chart-data="data" center-label="cLabel" donut-config="donutConfig" sparkline-config="sparklineConfig"></div>',$scope);
