...
The UXD team is proud to announce the $VERSION release of Angular PatternFly. This release includes the following changes.

$RELEASE_NOTES

Check out the Angular PatternfFly $VERSION Release Notes for more details:
...
{
cat <<- EEOOFF
    This script will send a release notice to the Angular Patternfly mailling list.
