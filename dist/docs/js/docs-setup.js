NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$scope amount angular api area array axis bind c3 chart chart-data chart-height chartctrl chartdata chartheight chartid charts class col-md-12 color config configuration container contents controller current d-- data dates day default defaultconfig determining directive display element examplesparkline1 examplesparkline2 examplesparkline3 examplesparkline4 full function functions gb generation gettime height html http js label label-title legend list list-style-type markup mhz module ng-controller options org override overrides patternfly percent percentage percentageconfig percentages pf-sparkline-chart point points properties push rendering return row script set setting settings show-x-axis show-y-axis showing showxaxis showyaxis size sparkline style today tooltip tooltipfn tooltiptype total true type unit units usageperday usageperdayconfig valid valueperday valueperdayconfig values var width xdata ydata"
    },
    {
      "section": "api",
