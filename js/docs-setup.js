NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$scope $window adipiscing aggregate aggstatusalt alt-layout alternate alternative angular api array border card carddemoctrl class clicks col-md-10 component configuration controller count counts depreciated directive display displaying displays easily equals fa fa-shield false function hides href html icon iconclass iconimage icons image image_path imagepath img js layout layouts left list-style-type main mini miniaggstatus miniaggstatus2 module navigate ng-controller nodes normal note notification notifications number object param patternfly pficon pficon-cluster pficon-container-node pficon-error-circle-o pficon-ok pficon-warning-triangle-o providers script show-top-border single status statuses style svg tall title top true var"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "$scope $window aapdemo002 accepts address allow angular api array border card carddemoctrl class clicks col-md-10 component configuration content controller core count cpu directive display displaying drift easily element fa fa-coffee fa-heart fa-motorcycle fa-shield false favorite flag function hides history host href html html-content htmlcontent icon iconclass iconimage image image_path imagepath img infastructure info infostatus infostatusalt infostatustitless infrastructure ip js left list-style-type localdomian localhost main mb module navigate ng-controller options patternfly power script show-top-border snapshots socket status strings style svg textual things tinycore-local title top true var vm vmware"
    },
    {
      "section": "api",
